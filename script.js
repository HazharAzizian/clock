// Get refereance to DOM elements
const body = document.querySelector("body"), 
    ...
    // chech if the mode is already set to "Dark Mode" in localStorage
    ...
    modeSwitch.addEventListener("click", () => {
        ...
        // check if the "dark" class is currently preseny on the body element
